<script lang="ts">
    ...
    onMount(() => {
        onblur = () => {
            document.body.className = 'bg-[#1e1e2e] motion-safe:transition-colors motion-safe:duration-300';
        };
...
<svelte:head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/abysmal26/snippets/JetBrains-Mono/font.css">
